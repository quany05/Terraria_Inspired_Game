...
set_property -dict {PACKAGE_PIN J1 IOSTANDARD LVCMOS25} [get_ports start]
set_property PACKAGE_PIN B16 [get_ports uart_rtl_0_rxd]
set_property PACKAGE_PIN A16 [get_ports uart_rtl_0_txd]
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports {uart_rtl_1_rxd}]
set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS33} [get_ports {uart_rtl_1_txd}]
