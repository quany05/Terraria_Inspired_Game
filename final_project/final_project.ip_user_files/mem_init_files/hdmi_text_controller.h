...
#define STUDENT1NETID "quan8"
#define STUDENT2NETID "lukew6"
...
struct TEXT_HDMI_STRUCT {
	...
	// Pad up to PALETTE_START
    uint8_t  			_pad[PALETTE_START - ROWS*COLUMNS*2];

    // Palette/control window starting at 0x2000
    // Palette: 8 words at 0x2000..0x201C (two 12-bit colors per 32-bit word)
    uint32_t 			PALETTE[8];
