...
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports {uart_rtl_1_txd}]
set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS33} [get_ports {uart_rtl_1_rxd}]
...
set_property IOSTANDARD TMDS_33 [get_ports {HDMI_tmds_data_n[*]}]
set_property IOSTANDARD TMDS_33 [get_ports {HDMI_tmds_data_p[*]}]
