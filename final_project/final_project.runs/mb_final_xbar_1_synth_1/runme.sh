...
HD_PWD='D:/UIUC/26Spring/ECE385/Final_Project/final_project/final_project.runs/mb_final_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_final_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_final_xbar_1.tcl
